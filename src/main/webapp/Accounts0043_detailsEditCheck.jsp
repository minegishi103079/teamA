                ...
                <div class="row g-3 align-items-center">
					...
					<div class="col-6 p-2">
                        <div class="form-check form-check-inline">
                            ...
                            value="0" <c:if test="${accounts.getAuthority()==0}">checked</c:if> > 
                          ...
                          <div class="form-check form-check-inline">
                            ...
                            value="1" <c:if test="${accounts.getAuthority()==1}">checked</c:if> >
                          ...
                          <div class="form-check form-check-inline">
                            ...
                            value="2" <c:if test="${accounts.getAuthority()==2}">checked</c:if> >
                          ...
                          <div class="form-check form-check-inline">
                            ...
                            value="3" <c:if test="${accounts.getAuthority()==3}">checked</c:if> >
