				...
				<div class="row g-3 align-items-center">
					...
					<div class="col-6 p-2">
						<input type="password" class="form-control" name="password1"
						 value="<c:out value="${accounts.getPassword()}"></c:out>" placeholder="パスワード" required>
					</div>
				</div>
                ...
                <div class="row g-3 align-items-center">
					...
					<div class="col-6 p-2">
						<input type="password" class="form-control" name="password2"
						 value="<c:out value="${accounts.getPassword()}"></c:out>" placeholder="パスワード(確認)" required>
					</div>
				</div>
                ...
                <div class="row g-3 align-items-center">
					<div class="col-4 d-flex flex-row-reverse">
						<label for="varidationTextarea" class="col-form-label">権限
							<button type="button" class="btn btn-secondary btn-sm"  value="<c:out value="${accounts.getAuthority()}"></c:out>" disabled>必須</button>
						</label>
					</div>
					<div class="col-6 p-2">
