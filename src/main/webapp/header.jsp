		...
		<a class="navbar-brand" href="#" style="padding: 13px;">物品売上管理システム</a>
			<!-- <div class="hstack gap-3"> -->
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav">
						<div class="pt-2 pb-2 p-1 ms-auto<c:if test="${page eq '0'}" > active</c:if>">
							<li class="nav-item"><a class="nav-link" href="C0020">ダッシュボード</a></li>
						</div>
						<div class="pt-2 pb-2 p-1 ms-auto<c:if test="${page eq '1'}" > active</c:if>">
							<li class="nav-item"><a class="nav-link" href="Sales0010">売上登録</a></li>
						</div>
						<div class="pt-2 pb-2 p-1 ms-auto<c:if test="${page eq '2'}" > active</c:if>">
							<li class="nav-item"><a class="nav-link" href="Sales0020">売上検索</a></li>
						</div>
						<div class="pt-2 pb-2 p-1 ms-auto<c:if test="${page eq '3'}" > active</c:if>">
							<li class="nav-item"><a class="nav-link" href="Accounts0030">アカウント登録</a></li>
						</div>
						<div class="pt-2 pb-2 p-1 ms-auto<c:if test="${page eq '4'}" > active</c:if>">
