		...
		<div class="offset-1 col-10" style="margin-top: 10vh;">
			...
			<form class="was-validated" action="">
				...
				<div class="row g-3 align-items-center">
					...
					<div class="col-6 p-2">
						<input type="password" class="form-control" value="<c:out value="${}"></c:out>" name="password1" placeholder="パスワード" disabled>
					</div>
				</div>
                ...
                <div class="row g-3 align-items-center">
					...
					<div class="col-6 p-2">
						<input type="password" class="form-control" value="<c:out value="${}"></c:out>" name="password2" placeholder="パスワード(確認)" disabled>
					</div>
				</div>
